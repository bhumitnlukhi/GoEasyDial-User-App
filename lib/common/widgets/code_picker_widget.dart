          ...
          child: Container(
            ...
            child: Dialog(
              child: SelectionDialog(
                ...
                flagDecoration: widget.flagDecoration, hideHeaderText: false, headerAlignment: MainAxisAlignment.center, headerTextStyle: widget.dialogTextStyle ?? const TextStyle(), topBarPadding: EdgeInsets.zero,
              ),
            ),
          ),
        ),
      ...
      Get.bottomSheet(
        ConstrainedBox(
          ...
          child: SelectionDialog(
            ...
            hideSearch: widget.hideSearch!,
            closeIcon: widget.closeIcon,
            hideHeaderText: false, headerAlignment: MainAxisAlignment.center, headerTextStyle: widget.dialogTextStyle ?? const TextStyle(), topBarPadding: EdgeInsets.zero,
          ),
        ),
